...
- **MCP 어댑터**: `:3001/mcp` 에 13개 툴(`register_project`/`scan_project`/…). domains 함수 재사용. 등록: `claude mcp add --transport http opspilot http://localhost:3001/mcp`. 데이몬 로그: `mcp/log.ts` (`OPS_TERM_LOG=off`).
